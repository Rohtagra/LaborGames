...
{
    public class AnswerRingMenu : MonoBehaviour
    {
        ...
        protected AnswerRingMenu Parent;
        [HideInInspector]
        public string Path;
        ...
        void Update()
        {
            ...
            if (Input.GetKeyUp(KeyCode.F))
            {
                ...
                {
                    var newSubRing = Instantiate(gameObject, transform.parent).GetComponent<AnswerRingMenu>();
